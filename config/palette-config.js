const palette_config = {
    lines: {
        ...
        items: [
            ...
            { name: '数据绑定', image: 'symbols/palette-icon/basic/数据绑定.json', type: ht.Node }, // done
            { name: '告警变色', image: 'symbols/palette-icon/basic/告警变色.json', type: ht.Node }, // done
            { name: '显示隐藏', image: 'symbols/palette-icon/basic/显示隐藏.json', type: ht.Node }, // done
            { name: '光字牌', image: 'symbols/palette-icon/basic/光字牌.json', type: ht.Node }, // done
            { name: '表格', image: 'symbols/palette-icon/basic/table-icon.json', type: ht.Node }, // done
            { name: '按钮', image: 'symbols/palette-icon/basic/按钮.json', type: ht.Node }, // done
            { name: '进度条', image: 'symbols/palette-icon/basic/进度条.json', type: ht.Node }, // done
            { name: '刻度线', image: 'symbols/palette-icon/basic/刻度线.json', type: ht.Node }, // done
            { name: '辅助点', image: 'symbols/palette-icon/lines/辅助点.json', type: ht.Node }, // done
            { name: '线路接合点', image: 'symbols/palette-icon/lines/线路接合点.json', type: ht.Node }, // done
            { name: '线路交叉点', image: 'symbols/palette-icon/lines/线路交叉点.json', type: ht.Node }, // done
            { name: '箭头', image: 'symbols/palette-icon/lines/箭头.json', type: ht.Node }, // done

            { name: '1/4圆弧', image: 'symbols/palette-icon/basic/4分之1圆弧.json', type: ht.Node }, // done
            { name: '1/2圆弧', image: 'symbols/palette-icon/basic/2分之1圆弧.json', type: ht.Node }, // done
            { name: '3/4圆弧', image: 'symbols/palette-icon/basic/4分之3圆弧.json', type: ht.Node }, // done
            { name: '圆形', image: 'symbols/palette-icon/basic/圆形.json', type: ht.Node }, // done
            { name: '圆角矩形', image: 'symbols/palette-icon/basic/圆角矩形.json', type: ht.Node }, // done
            { name: '矩形', image: 'symbols/palette-icon/basic/矩形.json', type: ht.Node }, // done
            { name: '三角形', image: 'symbols/palette-icon/basic/三角形.json', type: ht.Node }, // done
            { name: '梯形', image: 'symbols/palette-icon/basic/梯形.json', type: ht.Node }, // done
        ]
    },
    power: {
        name: '电路设备',
        items: [
            { name: '开关', image: 'symbols/palette-icon/new-energy/开关.json', type: ht.Node }, // done
            { name: '手车', image: 'symbols/palette-icon/new-energy/手车.json', type: ht.Node }, // done
            { name: '断路器', image: 'symbols/palette-icon/new-energy/断路器.json', type: ht.Node }, // done
            { name: '断路器（双测点）', image: 'symbols/palette-icon/new-energy/断路器（双测点）.json', type: ht.Node }, // done
            { name: '断路器组合', image: 'symbols/palette-icon/new-energy/断路器组合.json', type: ht.Node }, // done
            { name: '接地开关', image: 'symbols/palette-icon/new-energy/接地开关.json', type: ht.Node }, // done
            { name: '信号', image: 'symbols/palette-icon/new-energy/信号.json', type: ht.Node }, // done
            { name: '网络信号', image: 'symbols/palette-icon/new-energy/网络信号.json', type: ht.Node }, // done
            { name: '旋钮开关', image: 'symbols/palette-icon/new-energy/旋钮开关.json', type: ht.Node }, // done
            // { name: '硬压板', image: 'symbols/palette-icon/new-energy/硬压板.json', type: ht.Node },
            { name: '远方就地信号', image: 'symbols/palette-icon/new-energy/远方就地信号.json', type: ht.Node }, // done
            { name: '运行状态信号', image: 'symbols/palette-icon/new-energy/运行状态信号.json', type: ht.Node }, // done
            { name: '风机状态信号', image: 'symbols/palette-icon/new-energy/风机状态信号.json', type: ht.Node }, // done
            { name: '运行方式信号', image: 'symbols/palette-icon/new-energy/运行方式信号.json', type: ht.Node }, // done

            { name: '负载', image: 'symbols/palette-icon/new-energy/static/负载.json', type: ht.Node }, // done
            { name: '二极管', image: 'symbols/palette-icon/new-energy/static/二极管.json', type: ht.Node },
            { name: '电缆', image: 'symbols/palette-icon/new-energy/static/电缆.json', type: ht.Node }, // done
            { name: '接地', image: 'symbols/palette-icon/new-energy/static/接地.json', type: ht.Node }, // done
            { name: '电抗', image: 'symbols/palette-icon/new-energy/static/电抗.json', type: ht.Node }, // done
            { name: '放电间隙', image: 'symbols/palette-icon/new-energy/static/放电间隙.json', type: ht.Node }, // done
            { name: '接地放电间隙', image: 'symbols/palette-icon/new-energy/static/接地放电间隙.json', type: ht.Node }, // done
            { name: '避雷器', image: 'symbols/palette-icon/new-energy/static/避雷器.json', type: ht.Node }, // done
            { name: '接地避雷器', image: 'symbols/palette-icon/new-energy/static/接地避雷器.json', type: ht.Node }, // done
            { name: '熔断器', image: 'symbols/palette-icon/new-energy/static/熔断器.json', type: ht.Node }, // done
            { name: '线圈', image: 'symbols/palette-icon/new-energy/static/线圈.json', type: ht.Node }, // done
            { name: '消弧线圈', image: 'symbols/palette-icon/new-energy/static/消弧线圈.json', type: ht.Node }, // done
            { name: '电阻', image: 'symbols/palette-icon/new-energy/static/电阻.json', type: ht.Node }, // done
            { name: '电流互感器', image: 'symbols/palette-icon/new-energy/static/电流互感器.json', type: ht.Node }, // done
            { name: '接地电流互感器', image: 'symbols/palette-icon/new-energy/static/接地电流互感器.json', type: ht.Node },
            { name: '接地线圈互感器', image: 'symbols/palette-icon/new-energy/static/接地线圈互感器.json', type: ht.Node },
            { name: '带电显示器', image: 'symbols/palette-icon/new-energy/static/带电显示器.json', type: ht.Node }, // done
            { name: '接地电阻', image: 'symbols/palette-icon/new-energy/static/接地电阻.json', type: ht.Node }, // done
            { name: '接地电阻2', image: 'symbols/palette-icon/new-energy/static/接地电阻2.json', type: ht.Node }, // done
            { name: 'IGBT', image: 'symbols/palette-icon/new-energy/static/IGBT.json', type: ht.Node }, // done

            { name: '交流发电机', image: 'symbols/palette-icon/new-energy/static/交流发电机.json', type: ht.Node },
            { name: '星型变压器', image: 'symbols/palette-icon/new-energy/static/星型变压器.json', type: ht.Node },
            { name: '三角变压器', image: 'symbols/palette-icon/new-energy/static/三角变压器.json', type: ht.Node },
            { name: '接地变压器', image: 'symbols/palette-icon/new-energy/static/接地变压器.json', type: ht.Node },
            { name: '分接开关星型变压器', image: 'symbols/palette-icon/new-energy/static/分接开关星型变压器.json', type: ht.Node },
            { name: '开口三角变压器', image: 'symbols/palette-icon/new-energy/static/开口三角变压器.json', type: ht.Node },
            { name: '单绕组变压器', image: 'symbols/palette-icon/new-energy/static/单绕组变压器.json', type: ht.Node },
            { name: '双绕组变压器', image: 'symbols/palette-icon/new-energy/static/双绕组变压器.json', type: ht.Node },
            { name: '三绕组变压器', image: 'symbols/palette-icon/new-energy/static/三绕组变压器.json', type: ht.Node },
            { name: '四绕组变压器', image: 'symbols/palette-icon/new-energy/static/四绕组变压器.json', type: ht.Node },
            { name: '变压器常用接法', image: 'symbols/palette-icon/new-energy/static/变压器常用接法.json', type: ht.Node },
            { name: '变压器常用接法2', image: 'symbols/palette-icon/new-energy/static/变压器常用接法2.json', type: ht.Node },
            { name: '取样变压器', image: 'symbols/palette-icon/new-energy/static/取样变压器.json', type: ht.Node },

            { name: '逆变器', image: 'symbols/palette-icon/new-energy/static/逆变器.json', type: ht.Node },
            { name: '电压取样柜', image: 'symbols/palette-icon/new-energy/static/电压取样柜.json', type: ht.Node },
            { name: '电容器', image: 'symbols/palette-icon/new-energy/static/电容器.json', type: ht.Node },
            { name: '电容器组', image: 'symbols/palette-icon/new-energy/static/电容器组.json', type: ht.Node },
            { name: '动态无功补偿', image: 'symbols/palette-icon/new-energy/static/动态无功补偿.json', type: ht.Node },
            { name: '燃机发电机', image: 'symbols/palette-icon/new-energy/static/燃机发电机.json', type: ht.Node },
            // { name: '开关3', image: 'symbols/palette-icon/new-energy/static/刀闸开关.json', type: ht.Node },
            { name: '蓄电池组', image: 'symbols/palette-icon/new-energy/static/蓄电池组.json', type: ht.Node },
            { name: '静态开关模件', image: 'symbols/palette-icon/new-energy/static/静态开关模件.json', type: ht.Node },
            { name: '调压稳压器', image: 'symbols/palette-icon/new-energy/static/调压稳压器.json', type: ht.Node },
            { name: '风机模型', image: 'symbols/palette-icon/new-energy/static/风机模型.json', type: ht.Node },
        ]
    },
    // steam: {
    //     name: '火电相关',
    ...
    //         { name: '泵（单信号）', image: 'symbols/palette-icon/m-point/泵（单信号）.json', type: ht.Node },
    ...
    //         { name: '电动阀（单信号）', image: 'symbols/palette-icon/m-point/电动阀（单信号）.json', type: ht.Node },
    //         { name: '电动阀-2', image: 'symbols/palette-icon/m-point/电动阀-2.json', type: ht.Node },
    //         { name: '电动阀-头部', image: 'symbols/palette-icon/m-point/电动阀-头部.json', type: ht.Node },
    //         { name: "电动隔离开关", image: 'symbols/palette-icon/steam/电动隔离开关.json', type: ht.Node },
    //         { name: '气动阀', image: 'symbols/palette-icon/m-point/气动阀.json', type: ht.Node },
    //         { name: '气动阀（单信号）', image: 'symbols/palette-icon/m-point/气动阀（单信号）.json', type: ht.Node },
    ...
    //         { name: "气动调节阀", image: 'symbols/palette-icon/steam/气动调节阀.json', type: ht.Node },
    //         { name: '电磁阀', image: 'symbols/palette-icon/m-point/电磁阀.json', type: ht.Node },
    //         { name: '电磁阀（单信号）', image: 'symbols/palette-icon/m-point/电磁阀（单信号）.json', type: ht.Node },
    ...
    //         { name: '蝶阀-1', image: 'symbols/palette-icon/m-point/蝶阀-1.json', type: ht.Node },
    ...
    //         { name: '止回阀-1', image: 'symbols/palette-icon/steam/止回阀-1.json', type: ht.Node },
    //         { name: '节流阀', image: 'symbols/palette-icon/steam/节流阀.json', type: ht.Node },
    //         { name: '角阀', image: 'symbols/palette-icon/steam/角阀.json', type: ht.Node },
    //         { name: '直动型溢流阀', image: 'symbols/palette-icon/steam/直动型溢流阀.json', type: ht.Node },
    //         {
    //             name: '非弹簧式单向阀-简化',
    //             image: 'symbols/palette-icon/steam/非弹簧式单向阀-简化.json',
    //             type: ht.Node
    //         },
    //         { name: '过滤器', image: 'symbols/palette-icon/steam/过滤器.json', type: ht.Node },
    //         { name: '空气过滤器', image: 'symbols/palette-icon/steam/空气过滤器.json', type: ht.Node },
    //         { name: '通大气式油箱', image: 'symbols/palette-icon/steam/通大气式油箱.json', type: ht.Node },
    //         { name: '囊隔式充气蓄能器', image: 'symbols/palette-icon/steam/囊隔式充气蓄能器.json', type: ht.Node },
    //         { name: '冷却水系统-01', image: 'symbols/palette-icon/steam/冷却水系统-01.json', type: ht.Node },
    //
    //
    ...
    //         { name: '胶球循环装置', image: 'symbols/palette-icon/steam/胶球循环装置.json', type: ht.Node },
    ...
    //         { name: '100', image: 'symbols/palette-icon/steam/100.json', type: ht.Node },
    //         { name: '101', image: 'symbols/palette-icon/steam/101.json', type: ht.Node },
    //         { name: '102', image: 'symbols/palette-icon/steam/102.json', type: ht.Node },
    //         { name: '103', image: 'symbols/palette-icon/steam/103.json', type: ht.Node },
    //         { name: '104', image: 'symbols/palette-icon/steam/104.json', type: ht.Node },
    //         { name: '105', image: 'symbols/palette-icon/steam/105.json', type: ht.Node },
    //         { name: '超滤设备', image: 'symbols/palette-icon/steam/超滤设备.json', type: ht.Node },
    //         { name: '反渗透装置-1', image: 'symbols/palette-icon/steam/反渗透装置-1.json', type: ht.Node },
    //         { name: '反渗透装置-2', image: 'symbols/palette-icon/steam/反渗透装置-2.json', type: ht.Node },
    ...
    //         {
    //             name: '汽机与电机-系统总图',
    //             image: 'symbols/palette-icon/steam/风机与电机-系统总图.json',
    //             type: ht.Node
    //         },
    ...
    //         { name: '放空管', image: 'symbols/palette-icon/steam/旗.json', type: ht.Node },
    ...
    //         { name: '过滤器-拟物', image: 'symbols/palette-icon/steam/过滤器-拟物.json', type: ht.Node },
    ...
    //
    //         { name: '未知1', image: 'symbols/palette-icon/jd/未知1.json', type: ht.Node },
    //         { name: '未知2', image: 'symbols/palette-icon/jd/未知2.json', type: ht.Node },
    //         { name: '未知3', image: 'symbols/palette-icon/jd/未知3.json', type: ht.Node },
    //         { name: '未知4', image: 'symbols/palette-icon/jd/未知4.json', type: ht.Node },
    //         { name: '未知5', image: 'symbols/palette-icon/jd/未知5.json', type: ht.Node },
    //         { name: '未知6', image: 'symbols/palette-icon/jd/未知6.json', type: ht.Node },
    //         { name: '未知7', image: 'symbols/palette-icon/jd/未知7.json', type: ht.Node },
    //         { name: '未知8', image: 'symbols/palette-icon/jd/未知8.json', type: ht.Node },
    //         { name: '未知10', image: 'symbols/palette-icon/jd/未知10.json', type: ht.Node },
    //         { name: '未知11', image: 'symbols/palette-icon/jd/未知11.json', type: ht.Node },
    //         { name: '未知12', image: 'symbols/palette-icon/jd/未知12.json', type: ht.Node },
    //         { name: '未知13', image: 'symbols/palette-icon/jd/未知13.json', type: ht.Node },
    //         { name: '未知14', image: 'symbols/palette-icon/jd/未知14.json', type: ht.Node },
    //         { name: '未知15', image: 'symbols/palette-icon/jd/未知15.json', type: ht.Node },
    //         { name: 'MBM10', image: 'symbols/palette-icon/jd/MBM10.json', type: ht.Node },
    //         { name: 'TYB旁路调压器', image: 'symbols/palette-icon/jd/TYB旁路调压器.json', type: ht.Node },
    //         { name: '带式压滤机', image: 'symbols/palette-icon/jd/带式压滤机.json', type: ht.Node },
    //         { name: '电池巡检仪', image: 'symbols/palette-icon/jd/电池巡检仪.json', type: ht.Node },
    //         { name: '端子', image: 'symbols/palette-icon/jd/端子.json', type: ht.Node },
    //         { name: '墨盒', image: 'symbols/palette-icon/jd/墨盒.json', type: ht.Node },
    //         { name: '凝汽器', image: 'symbols/palette-icon/jd/凝汽器.json', type: ht.Node },
    //         { name: '汽轮机', image: 'symbols/palette-icon/jd/汽轮机.json', type: ht.Node },
    //         { name: '网', image: 'symbols/palette-icon/jd/网.json', type: ht.Node },
    //         { name: '线圈电源', image: 'symbols/palette-icon/jd/线圈电源.json', type: ht.Node },
    //         { name: '压缩机', image: 'symbols/palette-icon/jd/压缩机.json', type: ht.Node },
    //         { name: '转子', image: 'symbols/palette-icon/jd/转子.json', type: ht.Node },
    //         { name: '高低压缸', image: 'symbols/palette-icon/jd/高低压缸.json', type: ht.Node },
    //         { name: '多级水封', image: 'symbols/palette-icon/jd/多级水封.json', type: ht.Node },
    //         { name: '烟囱挡板', image: 'symbols/palette-icon/jd/烟囱挡板.json', type: ht.Node },
    //         { name: '风机', image: 'symbols/palette-icon/jd/风机.json', type: ht.Node },
    //         { name: '风机（单信号）', image: 'symbols/palette-icon/jd/风机（单信号）.json', type: ht.Node },
    //         { name: '加热器', image: 'symbols/palette-icon/jd/加热器.json', type: ht.Node },
    //         { name: '冷却风机', image: 'symbols/palette-icon/jd/冷却风机.json', type: ht.Node },
    //         { name: '气动调节阀', image: 'symbols/palette-icon/jd/气动调节阀.json', type: ht.Node },
    //         { name: '电动调节阀', image: 'symbols/palette-icon/jd/电动调节阀.json', type: ht.Node },
    //         { name: '燃机本体', image: 'symbols/palette-icon/jd/燃机本体.png', type: ht.Node },
    //         { name: '燃机本体1', image: 'symbols/palette-icon/jd/燃机本体1.json', type: ht.Node },
    //         { name: '燃机本体2', image: 'symbols/palette-icon/jd/燃机本体2.json', type: ht.Node },
    //         { name: '污泥浓缩池', image: 'symbols/palette-icon/jd/污泥浓缩池.json', type: ht.Node },
    //         { name: '光字牌（自定义）', image: 'symbols/palette-icon/jd/光字牌（自定义）.json', type: ht.Node },
    //         { name: '图', image: 'symbols/palette-icon/jd/图.png', type: ht.Node },
    //         { name: 'SFC元件', image: 'symbols/palette-icon/jd/未知9.json', type: ht.Node },
    //         { name: 'CARTRIDGE STATUS', image: 'symbols/palette-icon/jd/CARTRIDGE STATUS.png', type: ht.Node },
    //         { name: '燃机发电机出口断路器', image: 'symbols/palette-icon/jd/燃机发电机出口断路器.json', type: ht.Node },
    //         {
    //             name: '燃机发电机出口断路器(0,1信号)',
    //             image: 'symbols/palette-icon/jd/燃机发电机出口断路器(0,1信号).json',
    //             type: ht.Node
    //         },
    //         { name: '刀闸开关', image: 'symbols/palette-icon/jd/刀闸开关.json', type: ht.Node },
    //         { name: '电磁阀（新增）', image: 'symbols/palette-icon/jd/电磁阀（新增）.json', type: ht.Node },
    //         { name: '励磁开关', image: 'symbols/palette-icon/jd/励磁开关.json', type: ht.Node },
    //         { name: '人孔', image: 'symbols/palette-icon/jd/人孔.json', type: ht.Node },
    //         { name: '油泵', image: 'symbols/palette-icon/jd/油泵.json', type: ht.Node },
    //         { name: '前置模块出口关断阀', image: 'symbols/palette-icon/jd/前置模块出口关断阀.json', type: ht.Node },
    //         { name: '紧急关断阀', image: 'symbols/palette-icon/jd/紧急关断阀.json', type: ht.Node },
    //         { name: '燃机预混阀', image: 'symbols/palette-icon/jd/燃机预混阀.json', type: ht.Node },
    //         { name: '未知阀', image: 'symbols/palette-icon/jd/未知阀.json', type: ht.Node },
    //         { name: '未知阀(8信号)', image: 'symbols/palette-icon/jd/未知阀(8信号).json', type: ht.Node },
    //         { name: 'TCS字牌', image: 'symbols/palette-icon/jd/TCS字牌.json', type: ht.Node },
    ...
    others: {
        name: '其他',
        items: [
            // { name: '卡车', image: 'symbols/palette-icon/pics/truck.png', type: ht.Node },
