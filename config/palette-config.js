palette_config = {
    ...
    power: {
        ...
        items: [
            ...
            { name: '断路器（单信号）', image: 'symbols/palette-icon/sxjk/断路器（单信号）.json', type: ht.Node },
            ...
            { name: '逆止二极管', image: 'symbols/palette-icon/jd/逆止二极管.json', type: ht.Node },
        ]
    },
    // power: {
    //     name: '电路相关',
    ...
    steam: {
        ...
        items: [
            ...
            { name: '非弹簧式单向阀-简化', image: 'symbols/palette-icon/steam/非弹簧式单向阀-简化.json', type: ht.Node },
            ...
            { name: '燃机发电机出口断路器(0,1信号)', image: 'symbols/palette-icon/jd/燃机发电机出口断路器(0,1信号).json', type: ht.Node },
    ...
    others: {
        name: '其他',
        items: [
            { name: '截止阀(灰色)', image: 'symbols/palette-icon/others/截止阀(灰色).json', type: ht.Node },
            { name: '未知图元(Kpa)', image: 'symbols/palette-icon/others/未知图元(Kpa).json', type: ht.Node },
            { name: '密封风机', image: 'symbols/palette-icon/others/密封风机.json', type: ht.Node },
            { name: 'truck', image: 'symbols/palette-icon/pics/truck.png', type: ht.Node },
